...
export function ProjectContent({ id }: { id: string }) {
  const [lang, setLang] = React.useState<"en" | "ko">("en");
  ...
  const project = lang === "ko" ? koProjectDetails[id] : projectDetails[id];
      ...
      <div className="mx-auto max-w-6xl px-5 py-12 sm:px-8 sm:py-20">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
              ...
              <div className="flex items-center gap-2">
                <span className="text-accent">🏢</span>
                <div>
                  <div className="text-muted-2 text-xs">{lang === "ko" ? "조직" : "Organization"}</div>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-6">
            <ExpandableSection title={lang === "ko" ? "💡 문제 및 접근 방식" : "💡 Problem & Approach"} defaultExpanded={true}>
            ...
            {/* Outcome & Impact */}
            <ExpandableSection title={lang === "ko" ? "🎯 결과 및 영향" : "🎯 Results & Impact"} defaultExpanded={true}>
              <ul className="space-y-3 text-sm sm:text-base text-muted leading-7">
          ...
          <div className="lg:col-span-1 space-y-6 lg:sticky lg:top-24 lg:self-start">
            ...
            {project.repository && (
              <Card interactive>
                <div className="flex items-center gap-2 text-sm font-semibold text-foreground mb-4" style={{ fontFamily: "var(--font-geist-mono)" }}>
                  <span>📂</span>
                  <span>{lang === "ko" ? "리포지토리" : "Repository"}</span>
                </div>
